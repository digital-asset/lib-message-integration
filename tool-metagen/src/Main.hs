...
optParser = Options
    ...
    <*> option readLogLevel
            (long "log-level"
             ...
             <> help "log level")
    <*> switch (long "use-ghc-primitives")
  where
...
writeDaml
    ...
    -> Bool
    -> m ()
writeDaml file modu useGhcPrimitives =
    writeDoc file $ GenDaml.ppModule modu useGhcPrimitives
...
runXSD Options{..} inputFile modName = do
    ...
    writeDaml damlOutFile modu optUseGhcPrimitives
